...
/*
        ...
        System.out.println(systemZoneId.toString());

        ZoneId targetZoneId= ZoneId.of("America/Los_Angeles");

        ZonedDateTime targetDateTime= ZonedDateTime.of(currentDateTime,systemZoneId).withZoneSameInstant(targetZoneId);
        System.out.println("Date and Time in Los Angeles Time Zone: " + targetDateTime);
*/
        /*
        ZoneId USEast = ZoneId.of("America/New_York");
        LocalDate date = LocalDate.of(2023, MARCH, 25);
...
/*
        ...
        LocalDateTime beforeDST = LocalDateTime.of(2023, MARCH, 24, 12, 00);
        ...
        LocalDate newyear = LocalDate.of(2023, DECEMBER, 24);
